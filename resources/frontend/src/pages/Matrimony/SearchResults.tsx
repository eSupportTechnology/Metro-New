...
import AppliedFilters from './ViewMatrimony/AppliedFilters';
import GenderSelector from './ViewMatrimony/GenderSelector';
import FilterSection from './ViewMatrimony/FilterSection';
import Spinner from '../../components/Loader/Spinner';
import ProfileCard from './ViewMatrimony/ProfileCard';
import Pagination from './ViewMatrimony/Pagination';
            ...
            <div className="max-w-7xl mx-auto mt-14 pt-6 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="md:col-span-3">
                        ...
                        {!isLoading && !error && filteredProfiles.length > 0 && <Pagination currentPage={currentPage} totalPages={totalPages} setCurrentPage={setCurrentPage} />}
                    </div>
                </div>
            </div>
            <Footer />
